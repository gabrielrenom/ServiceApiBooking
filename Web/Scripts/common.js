...
/* Booking */
$(".types .counter").after('<img src="img/ico-question.gif" alt="Select filter" class="type-icon">');
$( ".booking .airport" ).filter(":last").css( "border-bottom-left-radius", "15px" );
$( ".booking .result-row" ).filter(":last").css( "border", "none" );
